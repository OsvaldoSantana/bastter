...
def test_E03_todo_portao_que_declara_ativo_le_o_proprio_interruptor():
    ...
    B-5 (24/09/2026): ate aqui o teste procurava a palavra `ativo` no codigo-fonte da
...
def test_P38_a_guarda_restaura_para_que_so_o_culpado_falhe(tmp_path):
    ...
    # B-7: sem `-p no:cacheprovider`, o Windows as vezes nega o rename da pasta de
...
def test_B2_a_guarda_vigia_as_fixtures_de_sessao(tmp_path):
    """B-2: `custos_originais` e `politica_original` eram protegidas so pela docstring
