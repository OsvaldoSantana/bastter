# -*- coding: utf-8 -*-
"""
B-1 (sessao-b, 24/09/2026): `estado_io._registro` decidia se um campo e texto com
...
def test_B1_o_modulo_sintetico_de_fato_nao_tem_future(tmp_path):
...
def test_B1_campo_str_de_modulo_sem_future_passa_pelo_registro(tmp_path):
    Conta = _importar(tmp_path).Conta
    problemas = []
...
def test_B1_campo_str_em_branco_continua_reprovado(tmp_path):
