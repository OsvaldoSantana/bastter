...
Responde ao backlog §7 da `auditoria-camada-alocacao.md` e à recomendação de sequência
da §8 do `escopo-campos-de-analise.md` ("bloco K primeiro — antes de qualquer campo
calculado").
