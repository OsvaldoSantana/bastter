# O `CLAUDE.md` até 26/09/2026 — história, não instrução

*Movido em 26/09/2026, inteiro e sem edição, do `CLAUDE.md` da raiz (commit `c85ce59`). A
sessão lia 45.983 tokens deste texto em toda abertura, e a maior parte era narrativa datada e
retratação. As **regras** que ele produziu continuam no `CLAUDE.md` vivo; aqui fica o
**porquê** de cada uma, com as retratações inteiras (§5-A: achado retirado nunca some).*

**Isto é registro, nunca instrução.** Se algo aqui contradisser o `CLAUDE.md` vivo, o vivo
ganha. Os links relativos foram reescritos para a pasta nova; o texto não.
...
Vivem em **[`docs/doutrinas.md`](../doutrinas.md)**, a fonte única (P2). São leitura
