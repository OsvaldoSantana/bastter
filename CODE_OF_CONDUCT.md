<!-- Contributor Covenant 2.1, tradução oficial para o português do Brasil, obtida em 25/09/2026 de
https://www.contributor-covenant.org/pt-br/version/2/1/code_of_conduct/code_of_conduct.md
(CC BY 4.0). Única mudança: o método de contato, que o original deixa em aberto. -->
...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, pelo relato privado do GitHub (aba *Security* → *Report a vulnerability* deste repositório), com "Conduta" no título. O relato chega só ao mantenedor. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
